...
export const UsersList: IUser[] = [ // precisa exportar pq vamos precisar usar ela em outros componentes, do tipo IUser que criamos em user.interface, passamos um array, pq vao ser varios usuarios (objetos)
